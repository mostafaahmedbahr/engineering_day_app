  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      providers: [
        ...
        ChangeNotifierProvider(
          create: (_) => StatisticsProvider( getIt.get<StatisticsRepoImpl>()..getStatistics(context: context, token: "27MWZQHh7CCP9msgcRklyJbYqrBpksnszYx6t3bMH8GjnIFuti4WxoYAUQJHKCjh")),
        ),
        ChangeNotifierProvider(
